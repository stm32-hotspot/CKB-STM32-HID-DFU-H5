...
#define USBD_PRODUCT_HS_STRING        "DFU HID in HS Mode" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "DFU HID in FS Mode" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING  "DFU HID Config" /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING      "DFU HID Interface" /* Add your Interface High Speed string */
#define USBD_CONFIGURATION_FS_STRING  "DFU HID Config" /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING      "DFU HID Interface" /* Add your Interface Full Speed string */
